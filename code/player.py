...
CANNOT_STAND_ON = ["E", "36", "37", "43", "44", "76", "77", "84", "86", "87", "110", "111", "112", "121", "122", "123", "130", "135", "138", "144",  "163", "164", "165",
...
def movement(player_x, player_y, list_of_events):
    ...
    #continue walking in previous direction
    if change_in_moving == False and (goes_up or goes_left or goes_down or goes_right): 
    ...
    if player_x < 0:
        ...
        player_x = screen_width  - player_img_width
            
    if player_y < 0:
        player_y = 0
    elif (player_y + player_img_height) > (screen_height-40):
        player_y = (screen_height - 40) - player_img_height
